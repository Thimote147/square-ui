...
| ------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------- |
| **Projects Timeline** | Timeline interface for managing projects.                                          | [View Demo](https://square-ui-projects-timeline.vercel.app) | [Source](https://github.com/ln-dev7/square-ui/tree/master/templates/projects-timeline) | [Ryco](https://x.com/_heyrico)           |
| **Calendar**        | Modern calendar interface with week view, event management, and scheduling.                                      | [View Demo](https://square-ui-calendar.vercel.app)        | [Source](https://github.com/Thimote147/square-ui/tree/master/templates/calendar)        | [Ryco](https://x.com/_heyrico)           |
...
| **Circle**          | Project management interface inspired by Linear. This application allows tracking of issues, projects and teams. | [View Demo](https://circle.thimotefetu.be)                      | [Source](https://github.com/ln-dev7/circle)                                          | Inspired by Linear                       |
